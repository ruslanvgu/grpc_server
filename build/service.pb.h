...
PROTOBUF_NAMESPACE_OPEN
template <>
::package::Empty* Arena::CreateMaybeMessage<::package::Empty>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Empty final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:package.Empty) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:package.Empty)
 private:
  class _Internal;
